...
if [ ! -f "/setup_complete" ]; then
    ...
    ESCAPED_PASS=$(echo -n "${SHOP_PGC_PASSWORD}" | sed 's/&/\&amp;/g; s/</\&lt;/g; s/>/\&gt;/g; s/"/\&quot;/g; s/'"'"'/\&#39;/g')
    ...
    mysql -B -h mariadb -u root bitnami_opencart -e "INSERT INTO oc_setting SET store_id = '0', \`code\` = 'payment_${DB_FIELD_NAME}_creditcard', \`key\` = 'payment_${DB_FIELD_NAME}_creditcard_cc_api_password_cc', \`value\` = '${ESCAPED_PASS}', serialized = '0';"
    ...
    mysql -B -h mariadb -u root bitnami_opencart -e "INSERT INTO oc_setting SET store_id = '0', \`code\` = 'payment_${DB_FIELD_NAME}_creditcard', \`key\` = 'payment_${DB_FIELD_NAME}_creditcard_cc_api_password_visa', \`value\` = '${ESCAPED_PASS}', serialized = '0';"
    ...
    mysql -B -h mariadb -u root bitnami_opencart -e "INSERT INTO oc_setting SET store_id = '0', \`code\` = 'payment_${DB_FIELD_NAME}_creditcard', \`key\` = 'payment_${DB_FIELD_NAME}_creditcard_cc_api_password_mastercard', \`value\` = '${ESCAPED_PASS}', serialized = '0';"
    ...
    mysql -B -h mariadb -u root bitnami_opencart -e "INSERT INTO oc_setting SET store_id = '0', \`code\` = 'payment_${DB_FIELD_NAME}_creditcard', \`key\` = 'payment_${DB_FIELD_NAME}_creditcard_cc_api_password_amex', \`value\` = '${ESCAPED_PASS}', serialized = '0';"
    ...
    mysql -B -h mariadb -u root bitnami_opencart -e "INSERT INTO oc_setting SET store_id = '0', \`code\` = 'payment_${DB_FIELD_NAME}_creditcard', \`key\` = 'payment_${DB_FIELD_NAME}_creditcard_cc_api_password_diners', \`value\` = '${ESCAPED_PASS}', serialized = '0';"
    ...
    mysql -B -h mariadb -u root bitnami_opencart -e "INSERT INTO oc_setting SET store_id = '0', \`code\` = 'payment_${DB_FIELD_NAME}_creditcard', \`key\` = 'payment_${DB_FIELD_NAME}_creditcard_cc_api_password_jcb', \`value\` = '${ESCAPED_PASS}', serialized = '0';"
    ...
    mysql -B -h mariadb -u root bitnami_opencart -e "INSERT INTO oc_setting SET store_id = '0', \`code\` = 'payment_${DB_FIELD_NAME}_creditcard', \`key\` = 'payment_${DB_FIELD_NAME}_creditcard_cc_api_password_discover', \`value\` = '${ESCAPED_PASS}', serialized = '0';"
    ...
    mysql -B -h mariadb -u root bitnami_opencart -e "INSERT INTO oc_setting SET store_id = '0', \`code\` = 'payment_${DB_FIELD_NAME}_creditcard', \`key\` = 'payment_${DB_FIELD_NAME}_creditcard_cc_api_password_unionpay', \`value\` = '${ESCAPED_PASS}', serialized = '0';"
    ...
    mysql -B -h mariadb -u root bitnami_opencart -e "INSERT INTO oc_setting SET store_id = '0', \`code\` = 'payment_${DB_FIELD_NAME}_creditcard', \`key\` = 'payment_${DB_FIELD_NAME}_creditcard_cc_api_password_maestro', \`value\` = '${ESCAPED_PASS}', serialized = '0';"
